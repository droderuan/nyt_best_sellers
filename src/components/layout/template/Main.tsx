...
const MainTemplate: React.FC<MainTemplate> = ({ appName, children }) => {
  return (
    <>
      <body className="flex flex-col items-center font-sans bg-slate-50 text-slate-900 min-h-[100vh]">
        ...
        <div className="max-w-xl pt-3 md:max-w-4xl xl:max-w-7xl">
          {children}
        </div>
        <footer className="w-full mt-auto py-2 bg-teal-100">
          <div className="m-auto max-w-xl py-3 md:max-w-4xl xl:max-w-7xl text-sm font-thin">
            ...
            <p className="text-center">
              Copyright (c) 2023 The New York Times Company. All Rights
              Reserved.
            </p>
          </div>
        </footer>
